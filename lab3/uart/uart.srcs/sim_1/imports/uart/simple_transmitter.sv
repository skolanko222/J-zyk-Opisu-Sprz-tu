...
//////////////////////////////////////////////////////////////////////////////////
//nb - size of data
//deep - number of commad and data in file loaded to memory in simple_transmitter
//ratio = fclk / baudrate - 1 (explanation in simple_receiver)
//
module simple_transmitter #(parameter nb = 8, deep = 20, ratio = 1) 
    (input clk, rst, str, output trn, fin);
...
integer inx, cnt;
reg [nb-1:0] tr_mem [1:deep];           //memory with commands and data to send
