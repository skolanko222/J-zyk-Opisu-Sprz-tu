...
HD_PWD='/home/stud2021/1kolanko/JOS/lab2/lab2/lab2.runs/ila_scope_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_scope.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_scope.tcl
