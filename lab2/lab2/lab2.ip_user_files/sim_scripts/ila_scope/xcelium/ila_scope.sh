...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../lab2.gen/sources_1/ip/ila_scope/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_scope xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_scope -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/stud2021/1kolanko/JOS/lab2/lab2/lab2.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_scope_sc.so .tmp_log xcelium_lib waves.shm c.obj)
