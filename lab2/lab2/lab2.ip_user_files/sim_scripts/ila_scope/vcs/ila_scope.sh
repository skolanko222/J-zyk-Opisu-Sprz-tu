...
#
# Script generated by Vivado on Fri Mar 22 13:10:09 CET 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : ila_scope.sh
...
#
# Usage        : ila_scope.sh
#                ila_scope.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_scope.sh [-reset_run]
#                ila_scope.sh [-reset_log]
#                ila_scope.sh [-help]
#
...
#                script (type 'ila_scope.sh -help' for more information).
#
...
# script info
echo -e "ila_scope.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_scope.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../lab2.gen/sources_1/ip/ila_scope/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_scope xil_defaultlib.glbl -o ila_scope_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_scope_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/stud2021/1kolanko/JOS/lab2/lab2/lab2.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ila_scope_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_scope_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_scope.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_scope.sh [-help]\n\
Usage: ila_scope.sh [-step]\n\
Usage: ila_scope.sh [-lib_map_path]\n\
Usage: ila_scope.sh [-reset_run]\n\
Usage: ila_scope.sh [-reset_log]\n\
Usage: ila_scope.sh [-keep_index]\n\
Usage: ila_scope.sh [-noclean_files]\n\n\
